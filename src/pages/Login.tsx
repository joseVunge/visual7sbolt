    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-secondary-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-primary-600 mb-2">Visual 7s</h1>
          <h2 className="text-2xl font-semibold text-gray-900">Entre na sua conta</h2>
          <p className="mt-2 text-gray-600">Plataforma de vendas e marketing digital</p>
        </div>
        ...
        <form className="mt-8 space-y-6 bg-white p-8 rounded-xl shadow-lg" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Email: admin@visual7s.com | Senha: admin123
            </p>
          </div>
        </form>
      </div>
